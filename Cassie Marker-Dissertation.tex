...
%%%%%%%%%%%%%%%%
% Title
\title{DEVELOPMENT OF A KNOWLEDGE BASE OF TI-ALLOYS FROM FIRST-PRINCIPLES AND THERMODYNAMIC MODELING}
...
% thesis/dissertation.
\collegesubmittedto{Intercollege Graduate Program in Materials Science and Engineering}
...
\readerfour
			{Susan Sinnott}
			{Head of the Department and Professor of Materials Science and Engineering}
