...
\noindent where $Z_{i}$ represents the partition function a state expressed by:
...
\noindent where $F_{i}$ is the Helmholtz energy of state $i$ and $E_{ik}$ is the energy eigenvalues of microstate $k$ in the $i$ state. $Z_{c}$ represents the combined system expressed by:
