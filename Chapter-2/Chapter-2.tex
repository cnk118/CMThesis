...
The first set of samples included four Ti-Nb samples made from pieces of titanium (PUT IN WHER) and niobium (PUT IN SIGMA) at 0.1, 0.12, 0.18, 0.2 mole fraction of Nb. The second set of samples included four Ti-Nb samples made from pieces of titanium (PUT IN WHER) and niobium (PUT IN SIGMA) at 0.1, 0.12, 0.18, 0.2 mole fraction of Nb. Two different titanium pieces were used because the SIGMA titnaium pieces were out but they both had the same purity. The alloyed samples were made using the MAM1, Edmund Buhler GmbH arc melter under argon atmosphere. The alloys were machined into a cylindrical shape (XX mm XX mm in diameter and thickness). The samples were then heat treated using the YYYY furance under vaccuum. The samples were annealed at XXXX K for 24 hours. Four samples, one at each composition, were quenched in XXXX. The other fours amples were slow cooled. 
