...
\begin{table}[H]
	...
	\begin{tabular}{ c c c c c c }
		\hline
		Phase & Space Group & \textit{a} ($\dot{A}$) & textit{b} ($\dot{A}$)  & textit{c} ($\dot{A}$) & Reference\\
		\hline
...
\newpage
\begin{table}[H]
	\caption{Equilibrium volume \textit{V}, bulk modulus \textit{B}, and the first derivative of bulk modulus with respect to pressure \textit{B'}, from fitted equilibrium properties from the EOS at 0 $^\circ$K compared to experimental work and previous DFT studies.}
	\centering
	\begin{tabular}{ c c c c c }
		\hline
		Phase & \textit{V} ($\dot{A}^3$/atom) & \textit{B} (GPa) & \textit{B'} & Reference\\
		\hline
...
\newpage
\begin{table}[H]
	\caption{Elastic stiffness constants and elastic properties predicted using the Hill approach and the scaling factors used in the Debye model, calculated from the Poisson ratio, see Eq. Y. To ensure the accuracy of the calculated scaling factor, the bulk modulus (\textit{B}$_{cij}$) calculated from the elastic constants was compared to the \textit{B}$_{EOS}$ calculated from the EOS fitting Eq. Y.}
	\centering
	\begin{tabular}{ c c c c c c }
		\hline
		  ...
		  \textit{B}$_{cij}$ (GPa) & 107 & 107 & 184 & 190 & 179\\
		  \textit{B}$_{EOS}$ (GPa) & 104 & & 182 & & \\
		\hline
	\end{tabular}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{Chapter-4/Figures/Tafinitetemp.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{Chapter-4/Figures/Snfinitetemp.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{Chapter-4/Figures/TaSn2finitetemp.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{Chapter-4/Figures/Ta3Snfinitetemp.png}
